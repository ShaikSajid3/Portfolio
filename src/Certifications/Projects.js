      ...
      <div className="project-inner-container row" style={{ marginLeft: '90px' }}>
        ...
        <div className="card" style={{ margin: '20px', width: '28rem' }}>
          <div className="card-body">
            ...
            <p className='card-text'>This project aims to provide a dynamic application for storing and retrieving student data.</p>
        ...
        <div className="card" style={{ margin: '20px', width: '28rem' }}>
          <div className="card-body">
            ...
            <p className='card-text'>This project aims to analyze synthetic airline data and derive insights that help to improve airline facilities.</p>
            <a href="https://github.com/ShaikSajid3/Business-Analytics-Virtual-Internship" className="card-text">
