  ...
  return (
    <div>
      ...
      <div className="card" style={{ margin: '20px', width: '28rem' }}>
        <div className="card-body">
          <h5 className="card-title">Intermediate <span className="right-span bg-success badge">Marks 976</span></h5>
      ...
      <div className="card" style={{ margin: '20px', width: '28rem' }}>
        <div className="card-body">
            <h5 className="card-title">SSC <span className="right-span bg-success badge">CGPA 10</span></h5>
